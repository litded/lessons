...
var fileDescriptor_8c585a45e2093e54 = []byte{
	...
	0x18, 0x35, 0x38, 0x83, 0xc0, 0x6c, 0xa3, 0x74, 0x2e, 0x6e, 0x67, 0xa0, 0xb2, 0xe0, 0xd4, 0xa2,
	0xb2, 0xcc, 0xe4, 0x54, 0x21, 0x2d, 0x2e, 0x8e, 0xe0, 0xc4, 0x4a, 0x8f, 0xd4, 0x9c, 0x9c, 0x7c,
	0x21, 0x5e, 0x3d, 0xb0, 0x61, 0x50, 0xdd, 0x52, 0xa8, 0x5c, 0x25, 0x06, 0x21, 0x1d, 0x2e, 0x2e,
	0xa0, 0x5a, 0xf7, 0xfc, 0xfc, 0x14, 0xa7, 0xca, 0x54, 0x42, 0xaa, 0x93, 0xd8, 0xc0, 0x8e, 0x32,
	0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0xc4, 0x65, 0x7f, 0x0f, 0xa2, 0x00, 0x00, 0x00,
}
...
func (c *chatServiceClient) SayGoodBye(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
	err := c.cc.Invoke(ctx, "/chat.ChatService/SayGoodBye", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedChatServiceServer) SayGoodBye(ctx context.Context, req *Message) (*Message, error) {
